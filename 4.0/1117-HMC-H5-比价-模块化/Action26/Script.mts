...
Browser("好买车").Page("好买车-真车实价比出来 让你买车不花冤枉钱").WebEdit("verifycode").Click
...
If isOlduser=0 Then
	...
	Browser("好买车").Page("好买车-真车实价比出来 让你买车不花冤枉钱").WebEdit("nickname").Click
	wait 1
	'wshShell.SendKeys "自动化测试帐号"
	'Browser("好买车").Page("车型详情页").WebEdit("新用户昵称").Set"4.0自动化测试帐号1"
	
	Browser("好买车").Page("好买车-真车实价比出来 让你买车不花冤枉钱").WebEdit("nickname").Set"自动化测试"
