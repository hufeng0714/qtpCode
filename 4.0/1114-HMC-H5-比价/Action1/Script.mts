...
wait 1
Browser("好买车").Page("好买车-首页").Image("马自达8图标").Click
wait 1
Browser("好买车").Page("好买车-首页").Image("马自达款型").Click
wait 1
...
wait 1
Browser("好买车").Page("车型详情页").WebElement("第二步款型选择").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("颜色选择").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("拍照选择-上沪牌").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("购车方式-全款购车").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("购车时间-3个月").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("区域-顾村").Click
wait 1

Browser("好买车").Page("车型详情页").WebElement("除去1个4S店").Click
wait 1
Browser("好买车").Page("车型详情页").WebElement("除去第2个4S店").Click
...
RunAction "adminLogin", oneIteration, phoneRan,isOlduser, verifyCode
...
RunAction "orderList", oneIteration,orderNo
