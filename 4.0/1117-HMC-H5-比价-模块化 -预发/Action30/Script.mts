...
wait 1
'Browser("管理后台系统界面").Page("系统主界面").Link("待报报价单-订单管理-测试环境").Click
'Browser("管理后台系统界面").Page("系统主界面").Link("待报报价单-订单管理-预发环境").Click
Browser("管理后台系统界面").Page("系统主界面").Link("待报报价单-订单管理-prod环境").Click
