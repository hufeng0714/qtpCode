...
Browser("4S店后台管理系统登录界面").Page("登录界面").WebEdit("用户名输入框").Set "ZLYLXFL004"
'Browser("4S店后台管理系统登录界面").Page("登录界面").WebEdit("用户名输入框").Set "DCYQXFL001"
'Updated by test maintenance run
'Browser("4S店后台管理系统登录界面_2").Page("4S店后台管理系统登录界面").WebEdit("empUser").Set "AJMLNJXFL001"
'Browser("4S店后台管理系统登录界面").Page("登录界面").WebEdit("用户名输入框").Set fsEmployee
'Updated by test maintenance run
'Browser("4S店后台管理系统登录界面").Page("登录界面").WebEdit("密码输入框").Set "123456"
Browser("4S店后台管理系统登录界面_2").Page("4S店后台管理系统登录界面").WebEdit("empPassword").Set "123456"
wait 1
'Updated by test maintenance run
Browser("4S店后台管理系统登录界面").Page("登录界面").Image("登录按钮").Click
Browser("4S店后台管理系统登录界面_2").Page("4S店后台管理系统登录界面").Image("login").Click
